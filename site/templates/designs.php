        ...
        <div class="container">
            <section class="page-content"><?php 
                ...
                if($user->hasRole('social-media-head') || $user->hasRole('social-media-member') || $user->isSuperuser())
                    echo "<p class='add'><a href='{$config->urls->admin}page/add/?parent_id={$page->id}'>Add Design</a></p>";
...
<?php if(!$config->ajax) if(!$config->ajax) include('./_foot.php'); // include footer markup ?>
